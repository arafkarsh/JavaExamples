 ...
 * @date:
 */
public class FixedDepositService extends AbstractBankWithdrawalService {
     ...
     * @param _accountType
     */
    public FixedDepositService(double _accountBalance, String _accountNumber, String _accountType) {
