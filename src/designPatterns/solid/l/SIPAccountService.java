 ...
 * @date:
 */
public class SIPAccountService extends AbstractBankDepositService {
     ...
     * @param _accountType
     */
    public SIPAccountService(double _accountBalance, String _accountNumber, String _accountType) {
